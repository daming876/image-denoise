...
def p2o(psf, shape):
    ...
    #print("otf",otf.shape)  #---->查看otf结构，otf torch.Size([1, 132, 132])
    print("psf:",psf.shape)  #---->查看psf结构， torch.Size([1, 25, 25])
...
class USRNet(nn.Module):
    ...
    def forward(self, x, k, sf, sigma):
        ...
        x = nn.functional.interpolate(x, scale_factor=sf, mode='nearest')  #图像上下采样，改变图像数组尺寸
